...
$('#downloadOvertime').onclick=async()=>{await saveNow(); location.href=`/download/overtime.xlsx?month=${$('#otMonth').value}`;}; $('#downloadOvertimeSchedule').onclick=async()=>{await saveNow(); location.href=`/download/overtime-schedule.xlsx?month=${$('#otMonth').value}`;}; $('#downloadCards').onclick=async()=>{await saveNow(); location.href=`/download/cards.xlsx?month=${$('#cardMonth').value}`;}; $('#downloadVehicle').onclick=async()=>{await saveNow(); location.href=`/download/vehicle.xlsx?month=${$('#vehMonth').value}`;};
